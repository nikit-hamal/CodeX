...
public class QwenResponseParser implements ResponseParser {
    ...
    private ParsedResponse fallback(String json) {
        ParsedResponse parsed = new ParsedResponse();
        parsed.rawResponse = json;
    ...
    private static com.codex.apk.QwenResponseParser.ParsedResponse parseFileOperationResponse(JsonObject jsonObj) {
        ...
        return new com.codex.apk.QwenResponseParser.ParsedResponse("file_operation", operations, new ArrayList<>(), explanation, true);
    }

    private static List<ChatMessage.FileActionDetail> toFileActionDetails(com.codex.apk.QwenResponseParser.ParsedResponse response) {
    ...
    private static class ParsedResponse {
        ...
        public ParsedResponse(String action, List<FileOperation> operations, List<PlanStep> planSteps, String explanation, boolean isValid) {
            this.action = action;
